...
> CycleGAN , StarGAN은 모두 Conditional GAN 기반의 pix2pix 구조를 사용한다. CycleGAN은 이미지를 받아서 이미지를 돌려주고, StarGAN은 이미지와 y(도메인 Vector)를 추가로 받아서 y에 맞는 이미지를 돌려준다.

### **1. Cycle GAN**

> [kaggle : 🌈CycleGAN Tutorial : Monet-to-Photo⛵️](https://www.kaggle.com/songseungwon/cyclegan-tutorial-monet-to-photo)
...
* (Step 15) Training
  ...
  + wgan처럼 n\_critic을 사용해서(discriminator를 더 많이 학습해서) 판별력을 높여준다.
